...
final class AccountOverviewTests: XCTestCase { // swiftlint:disable:this type_body_length
    ...
    func testAddPhoneNumber() throws {
        ...
        try app.textFields["pin-0"].enter(value: "0")
        try app.textFields["pin-1"].enter(value: "1")
        try app.textFields["pin-2"].enter(value: "2")
        try app.textFields["pin-3"].enter(value: "3")
        try app.textFields["pin-4"].enter(value: "4")
        try app.textFields["pin-5"].enter(value: "5")
