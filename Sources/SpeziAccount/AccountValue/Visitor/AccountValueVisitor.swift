...
///
/// Use the ``AcceptingAccountValueVisitor/acceptAll(_:)`` method on supporting types to visit all contained values.
public protocol AccountValueVisitor {
    ...
    ///
    /// - Note: This method is only called if the visitor is used using ``AcceptingAccountValueVisitor/acceptAll(_:)``.
