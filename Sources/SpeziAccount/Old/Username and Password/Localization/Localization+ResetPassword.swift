    ...
    public struct ResetPassword: Codable {
        ...
        public static let `default` = ResetPassword(
            ...
            username: FieldLocalizationResource(
                title: "UAP_RESET_PASSWORD_USERNAME_TITLE",
                placeholder: "UAP_RESET_PASSWORD_USERNAME_PLACEHOLDER",
                bundle: .module
            ),
        ...
        public init(
            ...
            self.resetPasswordActionButtonTitle = resetPasswordActionButtonTitle.localized.localizedString()
            self.processSuccessfulLabel = processSuccessfulLabel.localized.localizedString()
            self.defaultResetPasswordFailedError = defaultResetPasswordFailedError.localized.localizedString()
        }
    }
}
