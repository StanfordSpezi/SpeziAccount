    ...
    public struct Login: Codable {
        ...
        public static let `default` = Login(
            ...
            username: FieldLocalizationResource(
                title: "UAP_LOGIN_USERNAME_TITLE",
                placeholder: "UAP_LOGIN_USERNAME_PLACEHOLDER",
                bundle: .module
            ),
            password: FieldLocalizationResource(
                title: "UAP_LOGIN_PASSWORD_TITLE",
                placeholder: "UAP_LOGIN_PASSWORD_PLACEHOLDER",
                bundle: .module
            ),
        ...
        public init(
            ...
            self.loginActionButtonTitle = loginActionButtonTitle.localized.localizedString()
            self.defaultLoginFailedError = defaultLoginFailedError.localized.localizedString()
        }
    }
}
